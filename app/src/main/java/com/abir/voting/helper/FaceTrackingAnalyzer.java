...
public class FaceTrackingAnalyzer implements ImageAnalysis.Analyzer {
    ...
    public FaceTrackingAnalyzer(TextureView tv, ImageView iv, CameraX.LensFacing lens) {
        this.tv = tv;
        this.iv = iv;
    ...
    private void processFaces(List<FirebaseVisionFace> faces) {
        ...
        onTakePhoto.uploadImage(faceBitmap);
    ...
    public void setOnItemClickListener(OnTakePhoto listener) {
        onTakePhoto = listener;
    }
